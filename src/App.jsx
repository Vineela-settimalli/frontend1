    ...
    return (
      <>
        ...
        <section>
          ...
          <div className='card'>
          <img src={`${import.meta.env.BASE_URL}1.jpeg`} alt='Project One' />
            <label>Project One</label>
          </div>

          <div className='card'>
            <img src={`${import.meta.env.BASE_URL}2.jpeg`} alt='Project One' />
            <label>Project Two</label>
          </div>

          <div className='card'>
            <img src={`${import.meta.env.BASE_URL}3.jpeg`} alt='Project One' />
            <label>Project Three</label>
          </div>

          <div className='card'>
            <img src={`${import.meta.env.BASE_URL}4.jpeg`} alt='Project One' />
            <label>Project Four</label>
          </div>

          <div className='card'>
            <img src={`${import.meta.env.BASE_URL}5.jpeg`} alt='Project One' />
            <label>Project Five</label>
          </div>

          <div className='card'>
            <img src={`${import.meta.env.BASE_URL}6.jpeg`} alt='Project One' />
